...
label start:
    ...
    p "С каких пор это стало для тебя проблемой?"
    ...
    "Вдруг я ненароком поднёс чип к виску. Что произошло после этого? Я увидел АД."
...
label cycle1:
    ...
    p"	...	"
    p"	Насчёт \"мистера Молтисанти\": он имел ввиду Серхио Молтисанти. Итало-мексиканец, участвует в предвыборной компании, вероятно хочет воспользоваться подвернувшимся ему шансом."
    p"Хотя, кто после такого масштабного скандала не хочет? Харт отлетел и больше к нам не вернётся, самое время рвать, пока не проснулись остальные.	"
    "	Окей, но, чувак, чем ему может быть полезен чип в предвыборной гонке?	"
    p"	Хрен его знает. Предположу, что это следствие того, что Серхио предельно религиозный политик. Может быть, он и вправду верит во всю эту байду, что несёт с трибун, кто знает?"
    p"Так или иначе, вряд ли ему по какой-то другой причине понадобилось нечто, названное Частицей Бога.	"
    "	...	"
    ...
    "Я просто чип заберу. Хорошо? Не будет гнидами."
    ...
    "И вот теперь они выпученными глазами наблюдают за тем, как я держу чип. Не знаю, о чём они сейчас думают, но явно не о том, как отобрать чип."
